...
# --- FUNGSI MEMUAT DATA (VERSI SIMPLE) ---
@st.cache_data
def load_data_from_excel(path="data.xlsx"):
    ...
    try:
        ...
        # Gabungkan data Kab & Kota untuk kemudahan
...
def create_analysis_tab(level, info_df, parameter_df, kinerja_df, kondisi_df, stat_df):
    ...
    with filter_col:
        ...
        # Logika baru yang simpel berdasarkan kolom JENIS
        ...
        # Filter info_df berdasarkan level yang sedang aktif
        if level == 'Provinsi':
