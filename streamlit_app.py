...
def load_data_from_excel(path="data.xlsx"):
    try:
        ...
        # Data statistik dibuat kosong dulu untuk stabilitas
        stat_prov_df = pd.DataFrame() 
...
# --- FUNGSI GRAFIK ---
def display_chart(selected_pemda, selected_indikator, main_df, chart_type, color_palette):
    ...
    # Area statistik dinonaktifkan sementara
...
def create_analysis_tab(level, info_df, parameter_df, kinerja_df, kondisi_df, stat_df):
    ...
    with chart_col:
        if selected_indikator and selected_klaster:
            ...
            display_chart(selected_pemda, selected_indikator, main_df, chart_type, color_palette)
